...
class ChpSensor(RepvpnSensor):
    ...
    def __init__(self, sensor_service, config, poll_interval):             
        super(ChpSensor, self).__init__(sensor_service=sensor_service, config, poll_interval, value='value', measurement='cpu', value = 'value', measurement = 'cpu', tags = ['site','firewall', 'id', 'proc'], skip_zero = True)
